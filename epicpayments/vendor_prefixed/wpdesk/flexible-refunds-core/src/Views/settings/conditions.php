...
?>
		<?php \esc_html_e('Button visibility', 'flexible-refund-and-return-order-for-woocommerce');?>
	</th>
	<td>
...
if (!\FRFreeVendor\WPDesk\Library\FlexibleRefundsCore\Integration::is_super()) {
    ...
    \printf(\esc_html__('', 'flexible-refund-and-return-order-for-woocommerce'), '<a href="' . \esc_url($pro_url) . '">', '</a>');
    ?>
					</td>
				</tr>
			<?php 
