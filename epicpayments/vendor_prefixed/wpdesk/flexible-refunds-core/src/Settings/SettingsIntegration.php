...
class SettingsIntegration extends \WC_Settings_Page
{
    ...
    public function __construct(\FRFreeVendor\WPDesk\View\Renderer\Renderer $renderer)
    {
        ...
        $this->label = \esc_html__('Refund Settings', 'flexible-refund-and-return-order-for-woocommerce');
        /**
    ...
    {
        return ['' => \esc_html__('Order Refund', 'flexible-refund-and-return-order-for-woocommerce'), 'form' => \esc_html__('Refund Form', 'flexible-refund-and-return-order-for-woocommerce')];
    }
    /**
