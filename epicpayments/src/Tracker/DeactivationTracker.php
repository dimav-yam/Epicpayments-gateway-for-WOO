...
class DeactivationTracker implements Hookable {
	...
	public function load_deactivation_modal() {
		//$docs_url    = get_locale() === 'pl_PL' ? 'https://wpde.sk/flexible-refunds-for-woocommerce' : 'https://wpde.sk/flexible-refunds-for-woocommerce-docs';
		//$support_url = get_locale() === 'pl_PL' ? 'https://www.wpdesk.pl/support/' : 'https://www.wpdesk.net/support/';
